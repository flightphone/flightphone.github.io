...
void main() {
   ...
   </svg>`;const r=new ps().parse(e),s=new ne;return r.paths.forEach((a,o)=>{a.toShapes(!0).forEach((l,h)=>{const f=new sr(l,{depth:50,bevelEnabled:!1}),d=new Ne(f,t);d.scale.set(.015,.015,.015),s.add(d)})}),ar.add(s),s.rotateX(Math.PI),s.rotateY(-.3),s.translateX(-11),s.translateY(-3),i(e)}
