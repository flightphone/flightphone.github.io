...
void main() {
   ...
   </svg>`;const n=new ps().parse(t),r=new ee;n.paths.forEach((s,a)=>{s.toShapes(!0).forEach((c,l)=>{const h=new sr(c,{depth:50,bevelEnabled:!1}),f=new Ne(h,i);f.scale.set(.015,.015,.015),r.add(f)})}),ar.add(r),r.rotateX(Math.PI),r.rotateY(-.3),r.translateX(-11),r.translateY(-3)}
